...
[![License](https://img.shields.io/badge/License-HispanShield-red.svg?style=for-the-badge)](LICENSE)
[![Python](https://img.shields.io/badge/Python-3.11+-3776AB?style=for-the-badge&logo=python&logoColor=white)](https://www.python.org/)
[![FastAPI](https://img.shields.io/badge/FastAPI-0.111-009688?style=for-the-badge&logo=fastapi&logoColor=white)](https://fastapi.tiangolo.com/)
[![PostgreSQL](https://img.shields.io/badge/PostgreSQL-15+pgvector-336791?style=for-the-badge&logo=postgresql&logoColor=white)](https://www.postgresql.org/)
[![Next.js](https://img.shields.io/badge/Next.js-14-black?style=for-the-badge&logo=next.js&logoColor=white)](https://nextjs.org/)
[![Ollama](https://img.shields.io/badge/LLM-Ollama+ATALAYA-black?style=for-the-badge&logo=ollama)](https://ollama.com/)
...
[![OSINT](https://img.shields.io/badge/OSINT-9_Providers-red?style=for-the-badge)](backend/app/agents/providers/osint/)
[![Weapons](https://img.shields.io/badge/Weapons_DB-30+_Systems-orange?style=for-the-badge)](backend/app/db/seeds/weapons_seed.py)
...
graph TB
    ...
    subgraph BACKEND["⚙️ BACKEND SERVICES"]
        ...
        subgraph AGENTS["🤖 INTELLIGENCE AGENTS"]
            OSINT_AGENT[OSINT Agent<br/>9 Providers]
            SYNTHESIS[Synthesis Agent<br/>ATALAYA LLM]
            SCENARIO[Scenario Agent<br/>What-If]
            EAGLE[EagleEye<br/>Satellite]
            MONEY[MoneyTrail<br/>Financial]
            CYBER[CyberSentinel<br/>Cyber Intel]
            NARRATIVE[NarrativeWatch<br/>Disinfo]
            WARNING[EarlyWarning<br/>Alerts]
        end

        subgraph SERVICES["🔧 CORE SERVICES"]
            PREDICTION[Prediction ML<br/>Time Series]
            SNA[Network Analysis<br/>Graph SNA]
            RAG[RAG Service<br/>pgvector]
            EXPORT[Export Service<br/>PDF/DOCX]
            EDGE[Edge Sync<br/>Field Devices]
            ALERT[Alert System<br/>Thresholds]
        end
    end

    subgraph DATA_LAYER["💾 DATA LAYER"]
        POSTGRES[(PostgreSQL 15<br/>+ pgvector<br/>+ RLS)]
        REDIS[(Redis<br/>Cache/Queue)]
        
        subgraph MILITARY_DB["⚔️ MILITARY DATABASE"]
            WEAPONS[Weapon Systems<br/>30+ entries]
            TRANSFERS[Arms Transfers<br/>SIPRI data]
            BASES[Military Bases<br/>Geolocated]
            BUDGETS[Defense Budgets<br/>23 countries]
        end
    end

    subgraph LLM_LAYER["🧠 LLM INFERENCE"]
        OLLAMA[Ollama Local<br/>ATALAYA Profile]
        VLLM[vLLM<br/>Optional]
        OPENROUTER[OpenRouter<br/>PUBLIC only]
    end

    subgraph OSINT_SOURCES["📡 OSINT SOURCES"]
        RSS[30 RSS Feeds<br/>Reuters, BBC...]
        YT[10 YouTube<br/>CSIS, RAND...]
        GDELT[GDELT v2<br/>Global Events]
        SIPRI[SIPRI API<br/>Arms Transfers]
        FININT_API[World Bank<br/>Exchange Rates]
        CYBINT_API[Shodan, GreyNoise<br/>CISA KEV]
        GEOINT_API[Sentinel-2, USGS<br/>NASA EONET]
        SIGINT_API[AIS, ADS-B<br/>OpenSky]
        ACLED_API[ACLED<br/>Conflicts]
    end
    ...
    CELERY --> REDIS
    CELERY --> LLM_LAYER
    OSINT_AGENT --> OSINT_SOURCES
    POSTGRES --> MILITARY_DB
    FASTAPI --> RLS
    FASTAPI --> AUDIT

    style USER_LAYER fill:#1a1a2e,color:#fff,stroke:#4a4a8a
    style GATEWAY fill:#2e1a1a,color:#fff,stroke:#8a2a2a
    style BACKEND fill:#0d2137,color:#fff,stroke:#1e5f8a
    style DATA_LAYER fill:#1a3a1a,color:#fff,stroke:#2a8a2a
    style LLM_LAYER fill:#2e2a1a,color:#fff,stroke:#8a7a2a
    style OSINT_SOURCES fill:#3a1a3a,color:#fff,stroke:#8a2a8a
```
...
sequenceDiagram
    ...
    participant LLM as ATALAYA LLM
    participant DB as PostgreSQL
    participant OSINT as OSINT Sources

    U->>API: Solicitud de análisis
    API->>API: Auth + MFA + RLS
    API->>AG: Dispatch a agentes
    
    par Parallel Execution
        AG->>OSINT: Collect signals (9 providers)
        OSINT-->>AG: Raw intelligence data
        AG->>DB: Query military database
        DB-->>AG: Weapon/transfer data
    end
    
    AG->>LLM: Synthesis + Analysis
    LLM-->>AG: Structured report
    
    AG->>DB: Store results
    DB-->>API: Response
    API-->>U: Intelligence product
```
